...
namespace Yandex.API360 {
    public interface IPostSettingsClient {
        ...
        /// <returns></returns>
        public Task<UserPersonalSettings> GetUserPersonalSettingsAsync(ulong userId);
        /// <summary>
        ...
        /// <returns></returns>
        public Task<UserPersonalSettings> SetUserPersonalSettingsAsync(ulong userId, UserPersonalSettings UserSettings);
        /// <summary>
        ...
        /// <param name="userId">Идентификатор пользователя</param>
        /// <returns></returns>
        public Task<CollectAddressStatus> GetСollectAddressesAsync(ulong userId);
        /// <summary>
        ...
        /// <returns></returns>
        public Task<CollectAddressStatus> SetСollectAddressesAsync(ulong userId, CollectAddressStatus collectAddresses);
        /// <summary>
        ...
        /// <param name="userId">Идентификатор пользователя</param>
        /// <returns></returns>
        public Task<UserRulesList> GetUserRulesAsync(ulong userId);
        /// <summary>
        ...
        /// <returns></returns>
        public Task<ulong> AddUserRuleAsync(ulong userId, UserRule userRule);
        /// <summary>
        ...
        /// <returns></returns>
        public Task DeleteUserRuleAsync(ulong userId, ulong ruleId);
    }
}
